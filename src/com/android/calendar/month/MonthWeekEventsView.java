...
import com.android.internal.util.mm.Lunar;
import com.android.internal.util.mm.LunarFestival;
import com.android.internal.util.mm.SolarHoliDay;
import com.android.internal.util.mm.SolarTerm;
...
public class MonthWeekEventsView extends SimpleWeekView {
    ...
    protected void drawWeekNums(Canvas canvas) {
        ...
        for (; i < numCount; i++) {
            ...
            if (DeviceUtils.isLocale(Locale.CHINA) || DeviceUtils.isLocale(Locale.CHINESE)
                    || DeviceUtils.isLocale(Locale.TAIWAN)) {
                ...
                if (SolarTermStr.length() == 0) {
                    ...
                    if (SolarHoliDayStr.length() == 0) {
                        if (LunarFestivalStr.length() != 0) {
                            canvas.drawText(LunarFestivalStr, x, y + lunarTextHeight - 5,
                                    mLunarFestivalPant);
                        } else {
                            temp = fullchinadatestr.substring(fullchinadatestr.length() - 2,
                                    fullchinadatestr.length());
                    ...
                    canvas.drawText(TextUtils.isEmpty(LunarFestivalStr) ? SolarTermStr
                            : LunarFestivalStr, x, y + lunarTextHeight - 5, TextUtils
                            .isEmpty(LunarFestivalStr) ? mLunarPaint : mLunarFestivalPant);
                }
